...
@user11 = User.create!(email: "test11@test.com", first_name: "Guy", last_name: "Teub", password: "123456", password_confirmation: "123456", age: "22", phone_number: "0606060616", sex:"Homme", address: "rue ", zip_code: "44000", city: "Nantes", user_description: "fan de wagon")
...
p "Creating Events..."
event1 = Event.create!(title: "5vs5", description: "Nouveau dans la région, je cherche des joueurs pour continuer à pratiquer ce sport que j'adore !", date: "2023-02-08", time: "10:00:00", price: "8", address: "rue Oberkampf, Paris", level: "Intermédiaire", players_number: "8", duration: "80", user: @user1, sport: @sport1, age_mini: "7", age_maxi: "")
event2 = Event.create!(title: "Entre filles", description: "Suite à des désistements, je cherche de nouvelles personnes", date: "2023-02-09", time: "11:00:00", price: "0", address: "Route des Plaines du Loup 7, Lausanne", level: "Confirmé", players_number: "3", duration: "120", user: @user2, sport: @sport2, age_mini: "16", age_maxi: "")
event3 = Event.create!(title: "1vs1 minimum", description: "J'organise cette partie tous les semaines, bienvenue aux nouveaux !", date: "2023-02-10", time: "12:00:00", price: "7", address: "3 Bd Michelet, Marseille", level: "Confirmé", players_number: "1", duration: "60", user: @user3, sport: @sport39, age_mini: "18", age_maxi: "")
event4 = Event.create!(title: "3vs3 ou plus", description: "Bonne ambiance garantie !", date: "2023-02-11", time: "13:00:00", price: "0", address: "12 Rue de l'Extenwoerth, Strasbourg", level: "Pour tous", players_number: "6", duration: "60", user: @user4, sport: @sport4, age_mini: "7", age_maxi: "")
event5 = Event.create!(title: "4vs4", description: "Nouveau dans la région, je cherche des joueurs pour continuer à pratiquer ce sport que j'adore !", date: "2023-02-12", time: "10:00:00", price: "8", address: "35 Rue du Chevalier de la Barre, Paris", level: "Intermédiaire", players_number: "8", duration: "80", user: @user1, sport: @sport4, age_mini: "", age_maxi: "")
event6 = Event.create!(title: "1vs1 minimum", description: "Suite à des désistements, je cherche de nouvelles personnes", date: "2023-03-12", time: "11:00:00", price: "0", address: "Allée des Evadés, Peyrehorade", level: "Pour tous", players_number: "3", duration: "120", user: @user2, sport: @sport3, age_mini: "18", age_maxi: "30")
event7 = Event.create!(title: "A mon domicile", description: "J'organise cette partie tous les semaines, bienvenue aux nouveaux !", date: "2023-03-13", time: "12:00:00", price: "7", address: "Quatre Chemins de Montolivet, Marseille", level: "Confirmé", players_number: "2", duration: "60", user: @user3, sport: @sport17)
event8 = Event.create!(title: "5vs5", description: "Bonne ambiance garantie !", date: "2023-03-14", time: "13:00:00", price: "0", address: "Petite Rue d'Austerlitz, Strasbourg", level: "Pour tous", players_number: "6", duration: "60", user: @user4, sport: @sport1, age_mini: "", age_maxi: "40")
event9 = Event.create!(title: "Très Urgent", description: "Nouveau dans la région, je cherche des joueurs pour continuer à pratiquer ce sport que j'adore !", date: "2023-03-15", time: "10:00:00", price: "8", address: "rue Danielle Casanova, Saint-Denis", level: "Intermédiaire", players_number: "8", duration: "80", user: @user1, sport: @sport30, age_mini: "16", age_maxi: "25")
event10 = Event.create!(title: "En salle", description: "Suite à des désistements, je cherche de nouvelles personnes", date: "2023-03-16", time: "11:00:00", price: "0", address: "Avenue 8 Mai 1945, Bayonne", level: "Intermédiaire", players_number: "3", duration: "120", user: @user2, sport: @sport20, age_mini: "", age_maxi: "")
event11 = Event.create!(title: "En extérieur", description: "J'organise cette partie tous les semaines, bienvenue aux nouveaux !", date: "2023-03-17", time: "12:00:00", price: "7", address: "225 avenue Ibrahim Ali, Marseille", level: "Confirmé", players_number: "4", duration: "60", user: @user3, sport: @sport31, age_mini: "", age_maxi: "50")
event12 = Event.create!(title: "En salle", description: "Bonne ambiance garantie !", date: "2023-03-18", time: "13:00:00", price: "0", address: "2 rue de Zurich, Colmar", level: "Pour tous", players_number: "3", duration: "60", user: @user4, sport: @sport10, age_mini: "", age_maxi: "")
event13 = Event.create!(title: "En extérieur", description: "Nouveau dans la région, je cherche des joueurs pour continuer à pratiquer ce sport que j'adore !", date: "2023-03-18", time: "10:00:00", price: "8", address: "route de trompe, Peyrehorade", level: "Intermédiaire", players_number: "2", duration: "80", user: @user5, sport: @sport32, age_mini: "16", age_maxi: "50")
event14 = Event.create!(title: "Tous les lundis", description: "Nouveau dans la région, je cherche des joueurs pour continuer à pratiquer ce sport que j'adore !", date: "2023-03-18", time: "11:00:00", price: "0", address: "Place de la Concorde, Paris", level: "Confirmé", players_number: "8", duration: "120", user: @user6, sport: @sport34, age_mini: "", age_maxi: "")
event15 = Event.create!(title: "Bières offertes !", description: "Suite à des désistements, je cherche de nouvelles personnes", date: "2023-03-19", time: "12:00:00", price: "7", address: "Champs Elysées, Paris", level: "Confirmé", players_number: "1", duration: "60", user: @user7, sport: @sport16, age_mini: "", age_maxi: "45")
event16 = Event.create!(title: "En extérieur", description: "Bonne ambiance garantie !", date: "2023-03-20", time: "13:00:00", price: "0", address: "197 ancienne route du Grès, Orange", level: "Pour tous", players_number: "4", duration: "60", user: @user8, sport: @sport19, age_mini: "3", age_maxi: "")
event17 = Event.create!(title: "En salle", description: "Nouveau dans la région, je cherche des joueurs pour continuer à pratiquer ce sport que j'adore !", date: "2023-03-19", time: "10:00:00", price: "8", address: "rue de la République, Marseille", level: "Intermédiaire", players_number: "2", duration: "80", user: @user9, sport: @sport31, age_mini: "16", age_maxi: "50")
event18 = Event.create!(title: "En extérieur", description: "Nouveau dans la région, je cherche des joueurs pour continuer à pratiquer ce sport que j'adore !", date: "2023-03-19", time: "11:00:00", price: "0", address: "rue de la République, Marseille", level: "Confirmé", players_number: "1", duration: "120", user: @user10, sport: @sport33, age_mini: "", age_maxi: "")
event19 = Event.create!(title: "En salle", description: "Nouveau dans la région, je cherche des joueurs pour continuer à pratiquer ce sport que j'adore !", date: "2023-03-20", time: "12:00:00", price: "7", address: "Allée Arago, Bordeaux", level: "Confirmé", players_number: "1", duration: "60", user: @user11, sport: @sport22, age_mini: "12", age_maxi: "45")
event20 = Event.create!(title: "En salle", description: "Nouveau dans la région, je cherche des joueurs pour continuer à pratiquer ce sport que j'adore !", date: "2023-03-20", time: "13:00:00", price: "0", address: "Rue Albert de Mun, Caen", level: "Pour tous", players_number: "4", duration: "60", user: @user1, sport: @sport23, age_mini: "18", age_maxi: "")
event21 = Event.create!(title: "En salle", description: "Nouveau dans la région, je cherche des joueurs pour continuer à pratiquer ce sport que j'adore !", date: "2023-03-20", time: "10:00:00", price: "5", address: "rue du 14 juillet, Nantes", level: "Intermédiaire", players_number: "2", duration: "80", user: @user2, sport: @sport24, age_mini: "16", age_maxi: "")
event22 = Event.create!(title: "En salle", description: "Nouveau dans la région, je cherche des joueurs pour continuer à pratiquer ce sport que j'adore !", date: "2023-03-21", time: "11:00:00", price: "0", address: "Avenue de l'Architecte Cordonnier, Lille", level: "Confirmé", players_number: "1", duration: "120", user: @user3, sport: @sport25, age_mini: "", age_maxi: "")
event23 = Event.create!(title: "En salle", description: "Nouveau dans la région, je cherche des joueurs pour continuer à pratiquer ce sport que j'adore !", date: "2023-03-21", time: "12:00:00", price: "7", address: "Allée Nadault de Buffon, Rennes", level: "Confirmé", players_number: "1", duration: "60", user: @user4, sport: @sport26, age_mini: "", age_maxi: "")
event24 = Event.create!(title: "En salle", description: "Nouveau dans la région, je cherche des joueurs pour continuer à pratiquer ce sport que j'adore !", date: "2023-03-21", time: "13:00:00", price: "0", address: "Place du 11 Novembre 1918, Lyon", level: "Pour tous", players_number: "2", duration: "60", user: @user5, sport: @sport27, age_mini: "", age_maxi: "")
event25 = Event.create!(title: "En salle", description: "Nouveau dans la région, je cherche des joueurs pour continuer à pratiquer ce sport que j'adore !", date: "2023-03-22", time: "10:00:00", price: "8", address: "Rue de la halle, Bourges", level: "Pour tous", players_number: "9", duration: "60", user: @user8, sport: @sport1, age_mini: "16", age_maxi: "")
event26 = Event.create!(title: "En salle", description: "Nouveau dans la région, je cherche des joueurs pour continuer à pratiquer ce sport que j'adore !", date: "2023-03-22", time: "10:00:00", price: "8", address: "Allée du Pont de la Sarre, Clermont-Ferrand", level: "Pour tous", players_number: "9", duration: "60", user: @user9, sport: @sport1, age_mini: "16", age_maxi: "")
event27 = Event.create!(title: "En salle", description: "Nouveau dans la région, je cherche des joueurs pour continuer à pratiquer ce sport que j'adore !", date: "2023-03-22", time: "10:00:00", price: "8", address: "Place du Capitole, Toulouse", level: "Pour tous", players_number: "9", duration: "60", user: @user10, sport: @sport1, age_mini: "16", age_maxi: "")
event28 = Event.create!(title: "En salle", description: "Nouveau dans la région, je cherche des joueurs pour continuer à pratiquer ce sport que j'adore !", date: "2023-03-23", time: "10:00:00", price: "8", address: "Rue de l'Abbé Breuil, Perpignan", level: "Pour tous", players_number: "9", duration: "60", user: @user11, sport: @sport1, age_mini: "16", age_maxi: "")
event29 = Event.create!(title: "En salle", description: "Nouveau dans la région, je cherche des joueurs pour continuer à pratiquer ce sport que j'adore !", date: "2023-03-23", time: "10:00:00", price: "8", address: "52 Rue Verrerie, Dijon", level: "Pour tous", players_number: "9", duration: "60", user: @user7, sport: @sport1, age_mini: "16", age_maxi: "")
event30 = Event.create!(title: "En salle", description: "Nouveau dans la région, je cherche des joueurs pour continuer à pratiquer ce sport que j'adore !", date: "2023-03-23", time: "10:00:00", price: "8", address: "192 Grand'Rue, Poitiers", level: "Pour tous", players_number: "9", duration: "60", user: @user6, sport: @sport1, age_mini: "16", age_maxi: "")
...
Chatroom.create!(event_id: event17.id)
Chatroom.create!(event_id: event18.id)
Chatroom.create!(event_id: event19.id)
Chatroom.create!(event_id: event20.id)
Chatroom.create!(event_id: event21.id)
Chatroom.create!(event_id: event22.id)
Chatroom.create!(event_id: event23.id)
Chatroom.create!(event_id: event24.id)
Chatroom.create!(event_id: event25.id)
Chatroom.create!(event_id: event26.id)
Chatroom.create!(event_id: event27.id)
Chatroom.create!(event_id: event28.id)
Chatroom.create!(event_id: event29.id)
Chatroom.create!(event_id: event30.id)
